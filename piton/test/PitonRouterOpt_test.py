...
from ..PitonRouterOpt import PitonRouterOpt
...
class TestHarness( Component ):
  ...
  def construct( s, pos_x, pos_y, src_pkts, sink_pkts ):
    ...
    s.dut  = PitonRouterOpt( PitonPosition )
...
def test_sanity_check():
  dut = PitonRouterOpt( PitonPosition )
  dut.elaborate()
...
#-------------------------------------------------------------------------
# test case: basic_straight
#-------------------------------------------------------------------------

def basic_straight( pos_x, pos_y ):
  return [
    #      src                dst
    #      off     x  y     | off x     y      payload
    mk_pkt( n,     0, 0,      n,  0,    8, [ 0x8badf00d             ] ),
    # mk_pkt( n, pos_x, pos_y,  n,  0,    0, [ 0x8badf00d, 0xdeadbeef ] ),
  ]
...
def stream_straight( pos_x, pos_y ):
  return [
    #      src                dst
    #      off     x  y     | off x     y      payload
    mk_pkt( n,     0, 0,      n,  0,    8, [ 0x8badf00d             ] ),
    mk_pkt( n,     0, 0,      n,  0,    7, [ 0x8badf11d             ] ),
    mk_pkt( n,     0, 0,      n,  0,    6, [ 0x8badf22d             ] ),
    mk_pkt( n,     0, 0,      n,  0,    5, [ 0x8badf33d             ] ),
    mk_pkt( n,     0, 0,      n,  0,    4, [ 0x8badf44d             ] ),
  ]
...
def stream_straight_slift( pos_x, pos_y ):
  return [
    #      src                dst
    #      off     x  y     | off x     y      payload
    mk_pkt( n,     0, 0,      n,  0,    8, [             ] ),
...
table = [
  ...
  [ 'straight_basic',        basic_straight,        0,     1  ],
  [ 'straight_stream',       stream_straight,       0,     1  ],
  [ 'straight_sflit_stream', stream_straight_slift, 0,     1  ],
