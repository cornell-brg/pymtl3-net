#=========================================================================
# CMeshFlitNetworkRTL.py
#=========================================================================
# Flit-based CMesh network implementation.
#
# Author : Cheng Tan
#   Date : July 20, 2019
...
from CMeshFlitRouterRTL             import CMeshFlitRouterRTL
from channel.ChannelRTL             import ChannelRTL
from pymtl3.stdlib.ifcs.SendRecvIfc import *

class CMeshFlitNetworkRTL( Component ):
  def construct( s, PacketType, PositionType, 
    ...
    # Components
    s.routers  = [ CMeshFlitRouterRTL( PacketType, PositionType, num_inports, 
    ...
    for i in range( s.num_routers ):
      ...
      for j in range( num_nodes_each ):
        s.connect( s.recv[ i * num_nodes_each + j ], 
                   s.routers[ i ].recv[ 4 + j ] )
        s.connect( s.send[ i * num_nodes_each + j ], 
