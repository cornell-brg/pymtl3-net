#=========================================================================
# MeshFlitNetworkRTL.py
#=========================================================================
# Flit-based Mesh network implementation.
#
# Author : Cheng Tan
#   Date : July 20, 2019
...
from MeshFlitRouterRTL              import MeshFlitRouterRTL
from pymtl3.stdlib.ifcs.SendRecvIfc import *

class MeshFlitNetworkRTL( Component ):
  def construct( s, PacketType, PositionType, 
    ...
    s.routers  = [ MeshFlitRouterRTL( PacketType, PositionType )
