...
def test_adhoc():
  ...
  dut.get[0].rdy = b1(1)
  dut.get[0].msg = b16( 0xface )
  dut.hold[0]    = b1(0)
  dut.give.en    = b1(1)
  dut.eval_combinational()
  assert dut.give.rdy
  assert dut.give.msg == 0xface
  print( dut.line_trace() )
  dut.tick()

  # Cycle 2 - second flit, set hold logic, another flit comes in
  dut.get[0].rdy = b1(1)
  dut.get[0].msg = b16( 0xb00c )
  dut.hold[0]    = b1(1)

  dut.get[1].rdy = b1(1)
  dut.get[1].msg = b16( 0x0001 )
  dut.hold[1]    = b1(0)
  ...
  print( dut.line_trace() )
  assert dut.give.rdy
  assert dut.give.msg == 0xb00c
  dut.tick()

  # Cycle 3 - third flit from port0
  dut.get[0].rdy = b1(1)
  dut.get[0].msg = b16( 0x8bad )
  dut.hold[0]    = b1(1)

  dut.get[1].rdy = b1(1)
  dut.get[1].msg = b16( 0xdead )
  dut.hold[1]    = b1(0)
  ...
  print( dut.line_trace() )
  assert dut.give.rdy
  assert dut.give.msg == 0x8bad
  dut.tick()

  # Cycle 4 - last flit from port0
  dut.get[0].rdy = b1(1)
  dut.get[0].msg = b16( 0xf00d )
  dut.hold[0]    = b1(1)
  ...
  print( dut.line_trace() )
  assert dut.give.rdy
  assert dut.give.msg == 0xf00d
  dut.tick()

  # Cycle 5 - arbitrate header
  dut.get[0].rdy = b1(1)
  dut.get[0].msg = b16( 0xc001 )
  dut.hold[0]    = b1(0)
