"""
=========================================================================
RingFlitNetworkRTL.py
=========================================================================
Flit-based Ring network implementation.
...
from RingFlitRouterRTL        import RingFlitRouterRTL
from ocn_pclib.ifcs.CreditIfc import RecvRTL2CreditSendRTL, CreditRecvRTL2SendRTL

class RingFlitNetworkRTL( Component ):
  ...
  def construct( s,
    ...
    # Components
    s.routers    = [ RingFlitRouterRTL( PacketType, PositionType, 
                     num_routers, nvcs=nvcs )
                     for i in range( num_routers ) ]
    s.recv_adp   = [ RecvRTL2CreditSendRTL( PacketType, nvcs=nvcs, 
                     credit_line=credit_line )
                     for _ in range( num_routers ) ]
    s.send_adp   = [ CreditRecvRTL2SendRTL( PacketType, nvcs=nvcs, 
                     credit_line=credit_line )
                     for _ in range( num_routers ) ]
